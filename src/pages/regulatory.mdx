...
Any QMS, PLM, or custom system that implements the ROSIE API ([RFC-004](/ROSIE/specs/rfc-004/)) can serve as the SoR.
...
| Document | Purpose |
|----------|---------|
| [RFC-001: Data Standard](/ROSIE/specs/rfc-001/) | How requirements and traces are structured |
| [RFC-002: Engine Spec](/ROSIE/specs/rfc-002/) | How the Hard-Gate and sync work |
| [RFC-003: Evidence Standard](/ROSIE/specs/rfc-003/) | How evidence is captured and packaged |
| [RFC-004: API Interface](/ROSIE/specs/rfc-004/) | How ROSIE connects to your SoR |
| [RFC-005: TQ Baseline](/ROSIE/specs/rfc-005/) | How the tool validates itself |
