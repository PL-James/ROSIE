...
- **Data formats**: How to tag code and structure requirements ([RFC-001](/specs/rfc-001/))
- **Hash computation**: How to generate deterministic integrity fingerprints ([RFC-002](/specs/rfc-002/))
- **Evidence schema**: How to package test execution artifacts ([RFC-003](/specs/rfc-003/))
- **API contract**: The interface any SoR must implement ([RFC-004](/specs/rfc-004/))
- **Qualification protocol**: How to validate a ROSIE-compliant engine ([RFC-005](/specs/rfc-005/))
...
Any system that implements [RFC-004](/specs/rfc-004/)'s API contract can serve as the SoR: commercial QMS platforms, PLM systems, or custom-built approval applications.
