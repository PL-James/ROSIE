...
| `@gxp-traces` | CSV     | References to parent IDs (e.g., FRS or DS)    |
...
- [RFC-002: Engine Spec](/ROSIE/specs/rfc-002/) — Processing and synchronization of this data standard
- [RFC-003: Evidence Standard](/ROSIE/specs/rfc-003/) — Test output packaging
- [RFC-005: TQ Baseline](/ROSIE/specs/rfc-005/) — Reference data for engine qualification
