...
Submits `gxp-execution.json` (defined in [RFC-003](/ROSIE/specs/rfc-003/)) to the SoR.
...
- [RFC-001: Data Standard](/ROSIE/specs/rfc-001/) — Data structures sent via these endpoints
- [RFC-002: Engine Spec](/ROSIE/specs/rfc-002/) — Engine sequence diagrams utilizing these endpoints
- [RFC-003: Evidence Standard](/ROSIE/specs/rfc-003/) — Evidence package uploaded via `/evidence/upload`
