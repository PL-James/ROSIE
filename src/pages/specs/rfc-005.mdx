...
- **Auto-log**: Any failure of the Hard-Gate ([RFC-002](/ROSIE/specs/rfc-002/)) must automatically generate a deviation report in the SoR
...
| Test   | Evidence capture ([RFC-003](/ROSIE/specs/rfc-003/)) | Execution evidence (JSON)     |
...
- [RFC-001: Data Standard](/ROSIE/specs/rfc-001/) — Tag patterns validated by the Golden Repository
- [RFC-002: Engine Spec](/ROSIE/specs/rfc-002/) — Engine behavior qualified by OQ/PQ
- [RFC-003: Evidence Standard](/ROSIE/specs/rfc-003/) — Evidence format for qualification tests
- [RFC-004: API Interface](/ROSIE/specs/rfc-004/) — API endpoints used during qualification
