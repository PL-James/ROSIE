...
| Field | Type | Description |
|-------|------|-------------|
| `dependencies` | array | External repos with validated components |
| `dependencies[].repo` | string | Repository URL |
| `dependencies[].id_prefix` | string | Prefix for referenced IDs |
| `gxp_metadata.gamp_category` | number | GAMP 5 software category (1-5) |
| `gxp_metadata.risk_impact` | string | Risk classification (`Low`, `Medium`, `High`) |
...
1. Review the [Data Standard (RFC-001)](/specs/rfc-001/) for tagging syntax
2. Understand the [Engine Spec (RFC-002)](/specs/rfc-002/) for sync behavior
3. Learn about [Evidence Packaging (RFC-003)](/specs/rfc-003/) for test outputs
